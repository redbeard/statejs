...
$.extend(State.prototype, {
    ...
    start: function(options) {
		...
		{
			this.parent_state().start({ targetSub: this });
		}
	...
	transitionTo: function(otherState) {
		if (otherState == null) { throw ("Can't transition from " + this.fullName() + " as the other state is null."); }
		if (otherState == this) { throw ("Can't transition from " + this.fullName() + " to itself."); }
		if (!this.root().active) { 
